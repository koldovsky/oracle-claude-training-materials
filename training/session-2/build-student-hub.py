...
<ol><li>Розпакуйте <strong>весь</strong> ZIP зі збереженням структури тек. Переглядайте PDF, шпаргалку й демо без встановлення програм.</li><li>Для власної практики потрібні Python 3.10+, Git, SQLcl, Claude Code та збережене навчальне зʼєднання SQLcl <code>train</code> із Сесії 1. У Windows для Claude Code також потрібен Git Bash.</li><li>Відкрийте термінал у теці з <code>START-HERE.html</code> й виконайте наведені команди.</li></ol>
